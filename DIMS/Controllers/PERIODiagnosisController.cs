...
{
    public class PERIODiagnosisController : BaseController
    {
        private IUnitOfWork _uow;
        private IPERIODiagnosisCasesheetService _service;
        private IOPDPatientRegistrationService _opdService;

        public PERIODiagnosisController(IUnitOfWork uow, IPERIODiagnosisCasesheetService service, IUserService userservice,
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                return (ActionResult) this.View("../PERIODiagnosis/Index", (object) new DeptHomeViewModel()
                {
                    From_Date = DateTime.Now,
                    To_Date = DateTime.Now,
                    DeptId = 3,
                    ControllerName = "PERIODiagnosis"
                });
            }
            catch (Exception ex)
            {
        ...
        public ActionResult TreatmentIndex()
        {
            try
            {
                ...
                deptHomeViewModel.ControllerName = "PERIODiagnosis";
                return (ActionResult) this.View("../PERIODiagnosis/TreatmentIndex", (object) deptHomeViewModel);
            }
            catch (Exception ex)
            {
                return (ActionResult) this.RedirectToAction("ErrorWrite", new RouteValueDictionary((object) new
        ...
        public ActionResult Operations(long allotId, int patientId)
        {
            try
            {
                ...
                return (ActionResult) this.View("../PERIODiagnosis/PerioPatientTreatmentList",
        ...
        public ActionResult Create(long allotId, int patientId)
        {
            try
            {
                ...
                if (!this.User.Departments.Contains(3))
                    return (ActionResult) this.View("../Error/AccessDenied");
                PERIODiagnosisViewModel PERIODiagnosisViewModel = new PERIODiagnosisViewModel();
                return (ActionResult) this.View("../PERIODiagnosis/Create",
        ...
        [CustomAuthorize(Roles = "Admin, HOD, Staff, Student")]
        [HttpPost]
        public ActionResult Create(PERIODiagnosisViewModel model)
        {
            try
            {
                CustomPrincipal user = this.User;
        ...
        public ActionResult Edit(long allotId, int PerioId)
        {
            try
            {
                ...
                if (!this.User.Departments.Contains(3))
                    return (ActionResult) this.View("../Error/AccessDenied");
                PERIODiagnosisViewModel PERIODiagnosisViewModel = new PERIODiagnosisViewModel();
                return (ActionResult) this.View("../PERIODiagnosis/Edit",
        ...
        [CustomAuthorize(Roles = "Admin, HOD, Staff, Student")]
        [HttpPost]
        public ActionResult Edit(PERIODiagnosisViewModel model)
        {
            try
            {
        ...
        public ActionResult EditOnly(long allotId, int PerioId)
        {
            ...
            PERIODiagnosisViewModel PERIODiagnosisViewModel2 = this._service.BindEditPERIOPatientModel(allotId, PerioId);
            ...
            PERIODiagnosisViewModel2.EditCaseSheetAccess =
                source.Where<DeptPermissions>((Func<DeptPermissions, bool>)(x =>
                    ...
                    .ToList<DeptPermissions>().Count > 0;
            return (ActionResult)this.View("../PERIODiagnosis/Edit", (object)PERIODiagnosisViewModel2);
        }

        [CustomAuthorize(Roles = "Admin, HOD, Staff, Student")]
        [HttpPost]
        public ActionResult EditOnly(PERIODiagnosisViewModel model)
        {
            try
            {
                long allotId = model.studentAllotmentViewModel.AllotId;
        ...
        public ActionResult Search()
        {
            try
            {
                ...
                if (user.DeptPermission.Where<DeptPermissions>((Func<DeptPermissions, bool>) (x => x.DeptId.Equals(3)))
                        .ToList<DeptPermissions>().Count <= 0)
                    return (ActionResult) this.View("../Error/AccessDenied");
                return (ActionResult) this.View("../PERIODiagnosis/_PerioSearchOptions", (object) new PERIOSearchViewModel()
                {
                    From_Date = DateTime.Now,
                    To_Date = DateTime.Now
                });
        ...
        public ActionResult ApprovalQueue()
        {
            ...
            if (user.DeptPermission.Where<DeptPermissions>((Func<DeptPermissions, bool>) (x => x.DeptId.Equals(3)))
                    ...
                    .ToList<DeptPermissions>().Count <= 0)
                return (ActionResult) this.View("../Error/AccessDenied");
            return (ActionResult) this.View("../PERIODiagnosis/_PerioApprovalQueue",
        ...
        public JsonResult GetPERIOApprovalList(CasesheetApprovalListViewModel model)
        {
            ...
            string To_Date = model.To_Date.ToString("yyyy-MM-dd");
            string rootUrl = this.User.GetRootUrl();
            model.SearchDetails = this._service.perioDiagnosisCasesheetApprovalList(From_Date, To_Date, rootUrl);
            return this.Json((object) model.SearchDetails);
        }
        ...
        public ActionResult Approval(long allotId, int CaserecordId)
        {
            try
            {
                ...
                if (!this.User.Departments.Contains(3))
                    return (ActionResult) this.View("../Error/AccessDenied");
                PERIODiagnosisViewModel PERIODiagnosisViewModel1 = new PERIODiagnosisViewModel();
                PERIODiagnosisViewModel PERIODiagnosisViewModel2 = this._service.BindEditPERIOPatientModel(allotId, CaserecordId);
                PERIODiagnosisViewModel2.FileUploadlist = this._uow.Repository<FileUploadViewModel>()
                    .GetEntitiesBySql(string.Format(Queries.FileUploadList, (object) PERIODiagnosisViewModel2.PatientId,
                        (object) 3));
                PERIODiagnosisViewModel2.approvalViewModal = new ApprovalViewModal()
                {
                    CaserecordId = PERIODiagnosisViewModel2.PerioId,
                    DeptId = 3,
                    DoctorId = PERIODiagnosisViewModel2.studentAllotmentViewModel.DoctorId,
                    PatientId = (long) PERIODiagnosisViewModel2.PatientId,
                    ReferredTreatmentId = 0
                };
                if (!PERIODiagnosisViewModel2.Approval1)
                    PERIODiagnosisViewModel2.ApprovalType = 1;
                else if (PERIODiagnosisViewModel2.Approval1 && !PERIODiagnosisViewModel2.Approval2)
                    PERIODiagnosisViewModel2.ApprovalType = 2;
                else if (PERIODiagnosisViewModel2.Approval1 && PERIODiagnosisViewModel2.Approval2 && !PERIODiagnosisViewModel2.Approval3)
                    PERIODiagnosisViewModel2.ApprovalType = 3;
                PERIODiagnosisViewModel2.approvalViewModal.ApprovalTypeId = PERIODiagnosisViewModel2.ApprovalType;
                return (ActionResult) this.View("../PERIODiagnosis/Approval", (object) PERIODiagnosisViewModel2);
            }
            catch (Exception ex)
            {
                return (ActionResult) this.RedirectToAction("ErrorWrite", new RouteValueDictionary((object) new
        ...
        [CustomAuthorize(Roles = "Admin, HOD, Staff, Student")]
        [HttpPost]
        public ActionResult Approval(PERIODiagnosisViewModel model)
        {
            try
            {
                CustomPrincipal user = this.User;
                ...
                PERIODiagnosisCasesheet entity = new PERIODiagnosisCasesheet();
                ...
                this._uow.Repository<PERIODiagnosisCasesheet>().Update(entity, false);
        ...
        [CustomAuthorize(Roles = "Admin, HOD, Staff, Student")]
        [HttpPost]
        public ActionResult UpdateSendForApproval(PERIODiagnosisViewModel model)
        {
            try
            {
                long allotId = model.studentAllotmentViewModel.AllotId;
        ...
        [HttpPost]
        public ActionResult InvestigationApproval(PERIODiagnosisViewModel model)
        {
            CustomPrincipal user = this.User;
            long allotId = model.studentAllotmentViewModel.AllotId;
            int perioId = model.PerioId;
        ...
        [HttpPost]
        public ActionResult ReferralApproval(PERIODiagnosisViewModel model)
        {
            CustomPrincipal user = this.User;
            long allotId = model.studentAllotmentViewModel.AllotId;
            int perioId = model.PerioId;
        ...
        [HttpPost]
        public ActionResult TreatmentApproval(PERIODiagnosisViewModel model)
        {
            CustomPrincipal user = this.User;
            long allotId = model.studentAllotmentViewModel.AllotId;
            int perioId = model.PerioId;
