...
// Type: DIMS.ViewModels.PROSSearchDetails
...
{
  public class PROSSearchDetails : EntityBase
  {
    ...
    public int? ProsthoId { get; set; }

    public string ProsthoNo { get; set; }

    public string ProsthoDate { get; set; }
