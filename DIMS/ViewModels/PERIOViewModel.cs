...
// Type: DIMS.ViewModels.PERIOViewModel
...
{
  public class PERIOViewModel : EntityBase
  {
    private DateTime _PerioDate = DateTime.Now;

    public PERIOViewModel()
    {
    ...
    public IEnumerable<PERIOCasesheetProperties> Proplist { get; set; }
    ...
    public IEnumerable<PERIOViewModel> Treatmentlist { get; set; }
